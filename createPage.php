...
<body>
	...
	<div id='modalCompose'>
		...
		<form id='form1' method='post'>
			<div id='modalArt'><img src='noArt.png'></div>
			<!--need to supply post id with hidden field-->
			<input type='text' id='songName' maxlength='40' autocomplete='off' placeholder='Request a song*' required>
			<div type='text' id='songSuggest'></div>
